...
<s:form>
	...
	<s:textfield name="applicant.address.addition" key="lbl.addressAddition" requiredLabel="true" size="40" maxsize="80"/>
	<s:textfield name="applicant.address.telephoneNumber" key="lbl.telephoneNumber" requiredLabel="true" size="15" maxsize="15"/>
	<s:textfield name="applicant.address.fax" key="lbl.fax" requiredLabel="true" size="15" maxsize="15"/>
