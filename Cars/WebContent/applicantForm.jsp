...
<s:form>
	...
	<s:textfield name="applicant.forename" key="lbl.firstName" size="40" maxlength="100" requiredLable="true" />
	...
	<s:textfield name="applicant.placeOfBirth" key="lbl.placeOfBirth" requitedLabel="true" />
	<s:textarea name="applicant.address" key="lbl.address" requitedLabel="true" />
